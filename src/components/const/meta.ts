export const siteName = 'blog.sewera.dev'
export const defaultLanguage = 'en-US'
export const defaultLicense = 'CC BY-SA 4.0'
export const defaultAuthor = 'Blazej Sewera'

export const baseSiteRoot = 'https://www.sewera.dev'
export const blogSiteRoot = '/'
export const blogSiteRootAbsolute = 'https://blog.sewera.dev'
export const githubProfile = 'https://github.com/sewera'
export const mastodonProfile = 'https://hachyderm.io/@sewera'
